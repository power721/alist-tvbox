...
/** V18:网盘播放内容的跨端规范标识 —— 分享身份(盘类型@分享ID@提取码) + 资源内相对路径。 */
public class V18__PlaybackDrivePath extends BaseJavaMigration {
    @Override
    public void migrate(Context context) throws Exception {
        ...
        addColumn(connection, table, "drive_share_key", "VARCHAR(255)");
        addColumn(connection, table, "drive_path", "TEXT");
    }
