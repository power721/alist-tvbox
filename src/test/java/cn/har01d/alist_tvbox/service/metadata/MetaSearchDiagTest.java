...
class MetaSearchDiagTest {
    ...
    void searchFanrenXiuxian() {
        ...
        try {
            List<MetadataSearchItem> bangumi = new BangumiMetadataProvider(new MetadataHttp(null), new MetadataHealth(), null, null).search(keyword);
        ...
        try {
            List<MetadataSearchItem> tmdb = new TmdbMetadataProvider(settingRepository, new MetadataHttp(null), new MetadataHealth(), null, null).search(keyword);
