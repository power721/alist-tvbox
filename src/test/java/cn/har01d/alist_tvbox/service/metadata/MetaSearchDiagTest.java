...
class MetaSearchDiagTest {
    ...
    void searchFanrenXiuxian() {
        ...
        try {
            List<MetadataSearchItem> bangumi = new BangumiMetadataProvider(new MetadataHttp(null), new MetadataHealth(), null).search(keyword);
        ...
        try {
            List<MetadataSearchItem> tmdb = new TmdbMetadataProvider(settingRepository, new MetadataHttp(null), new MetadataHealth(), null).search(keyword);
        ...
        try {
            List<MetadataSearchItem> douban = new DoubanMetadataProvider(null, new MetadataHttp(null), new MetadataHealth(), null, null, null, null).search(keyword);
